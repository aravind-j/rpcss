...
[![Last-changedate](https://img.shields.io/badge/last%20change-2026--05--30-yellowgreen.svg)](https://github.com/aravind-j/rpcss/)
[![Zenodo
DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.14889174.svg)](https://doi.org/10.5281/zenodo.14889174)
[![Website -
...
```
    ...
    To cite the R package 'rpcss' in publications use:
      ...
      Aravind, J. and Singh, A. M. (2026).  rpcss: Constitution of Core Collections by Principal Component
      Scoring Strategy. R package version 0.1.1.9000,
